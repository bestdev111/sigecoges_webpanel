...
function Activity(props) {
  ...
  useEffect(() => {
    if (activityData !== [] && activityData[0] !== undefined && geofenceData && geofenceData !== undefined) {
      let tempHours = 0
      activityData[0].forEach(element => {
        tempHours = tempHours + element.hours;
      });
      setTotalSalary(tempHours * props.rate + props.salary)
