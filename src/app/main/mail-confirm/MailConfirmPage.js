...
function MailConfirmPage() {
  ...
  const [focusMail, setFocusMail] = useState(null);
  useEffect(() => {
    if (window.localStorage.getItem('mail-confirm')) {
      setFocusMail(window.localStorage.getItem('mail-confirm'));
    }
  }, []);
  if (!focusMail) {
    return (
            ...
            <Card className="w-full max-w-384">
              <CardContent className="flex flex-col items-center justify-center p-16 sm:p-24 md:p-32">
                ...
                <Typography className="text-center w-full" color="textSecondary">
                  We sent the mail to your mail inbox.
                </Typography>
          ...
          <Card className="w-full max-w-384">
            <CardContent className="flex flex-col items-center justify-center p-16 sm:p-24 md:p-32">
              ...
              <Typography className="text-center mb-16 w-full" color="textSecondary">
                A confirmation e-mail has been sent to <b>{focusMail}</b>.
              </Typography>
